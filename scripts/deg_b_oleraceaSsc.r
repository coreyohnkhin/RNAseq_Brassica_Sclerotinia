...
ctrl <- read_delim("data/featurecountmatrices/N1909Pet_ControlSsc.txt",
                   skip = 1, show_col_types = FALSE)
inf  <- read_delim("data/featurecountmatrices/N1909Pet_InfectedSsc.txt",
                   skip = 1, show_col_types = FALSE)
...
Heatmap(vst[head(res$gene,50),], name="VST",
  ...
  (function(ht){
     ...
     pdf("figures/heatmap_top50_Ssc.pdf",6,8); draw(ht); dev.off()
   })
